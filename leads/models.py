...
class ConfiguracaoIA(models.Model):
    ...
    prompt_mensagem_base = models.TextField(
        default=(
            ...
            "O contexto do negócio pode não incluir um nome de empresa. Por isso, depois da "
            "saudação, NUNCA comece a se apresentar com 'Somos' ou 'Sou' (ex: 'sou da...', "
            "'somos a...', 'somos que...') — sem um nome pra completar essas frases elas saem "
            "quebradas. Em vez disso, comece direto com um verbo de ação descrevendo o que o "
            "negócio faz ou vende (ex: 'Vendemos...', 'Produzimos...', 'Trabalhamos com...', "
            "'Fazemos...'), usando as palavras do contexto fornecido. "
